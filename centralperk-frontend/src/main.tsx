...
const setupEnvText = `NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_URL=https://your-project.supabase.co
NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_PROJECT_ID=your_project_id
NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_PUBLISHABLE_KEY=your_publishable_key_here
NEXT_PUBLIC_SCM_FRONTEND_SUPABASE_ANON_KEY=your_anon_key_here
NEXT_PUBLIC_SCM_FRONTEND_ENABLE_DEMO_AUTH=false
NEXT_PUBLIC_SCM_FRONTEND_FORCE_CUSTOMER_DEMO_AUTH=false`;
    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: "20px", fontSize: "15px", lineHeight: 1.8, color: "#334155" }}>
          ...
          <div>3. Restart <code>npm run dev</code> and reload <code>http://localhost:3010</code>.</div>
        </div>
      </div>
    </div>,
  );
