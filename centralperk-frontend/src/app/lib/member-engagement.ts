...
function useRemoteChallengeLeaderboardView() {
  return process.env.NEXT_PUBLIC_ENABLE_CHALLENGE_LEADERBOARD_VIEW === "true";
}
...
export async function loadChallengeLeaderboard(challengeId: string) {
  ...
  if (!useRemoteChallengeLeaderboardView()) return [] as ChallengeLeaderboardEntry[];
