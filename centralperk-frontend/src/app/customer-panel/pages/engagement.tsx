...
import { createReferralViaApi, loadReferralsViaApi } from "../../lib/api";
...
export default function CustomerEngagementPage() {
  ...
  useEffect(() => {
    ...
    loadReferralsViaApi(user.memberId)
      .then(setMyReferrals)
  ...
  const handleCreateReferral = () => {
    ...
    createReferralViaApi({
      ...
      .then(() => loadReferralsViaApi(user.memberId))
      .then((rows) => {
        setMyReferrals(rows);
        setReferralEmail("");
        toast.success("Referral created.", {
          description: "The invite was saved and queued for email delivery.",
        });
      })
