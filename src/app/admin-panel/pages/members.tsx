    ...
    <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-between rounded-2xl border border-[#dbe8f6] bg-white p-4">
            ...
            <div className="mt-4 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
              <div className="min-w-0 flex-1">
                ...
                <select
                  id="segment-filter"
                  className="mt-2 h-11 w-full rounded-xl border border-[#d7e3f3] bg-[#f7f9fc] px-4 text-sm text-[#10213a] shadow-sm outline-none transition focus:border-[#1bb9d3] focus:ring-2 focus:ring-[#1bb9d3]/20"
                  value={segmentFilter}
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Button
                  type="button"
                  variant="outline"
                  className="h-11 rounded-xl border-[#c9d8eb] bg-white px-5 text-[#1A2B47] hover:bg-[#f5f9ff]"
                  onClick={() => {
                    setEditingSegmentId(null);
                    setSegmentName("");
                    setSegmentDescription("");
                ...
                <Button className="h-11 rounded-xl bg-[#1A2B47] px-5 text-white hover:bg-[#152238]" onClick={handleExport}>
                  Export Segment List
                </Button>
              </div>
            </div>
            ...
            <div key={segment.id} className="flex flex-col gap-3 rounded-2xl border border-[#dbe8f6] bg-gradient-to-r from-white to-[#f8fbff] p-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex gap-2 self-start sm:self-auto">
                <Button
                  variant="outline"
                  size="sm"
                  className="rounded-lg border-[#c9d8eb] bg-white text-[#1A2B47] hover:bg-[#f5f9ff]"
                  onClick={() => {
                ...
                <Button variant="outline" size="sm" className="rounded-lg border-[#f0c6c6] text-[#9f2d2d] hover:bg-[#fff5f5]" onClick={() => handleDeleteSegment(segment.id)}>Delete</Button>
              </div>
            </div>
          ))}
      ...
      <div className="bg-white rounded-2xl border border-[#9ed8ff] p-5 shadow-sm">
        ...
        <div className="mt-4 flex flex-col gap-3 md:flex-row md:items-end">
          ...
          <Button className="h-11 rounded-xl bg-[#1A2B47] px-5 text-white hover:bg-[#152238]" onClick={handleBulkAssign}>Assign Members</Button>
        </div>
      </div>
