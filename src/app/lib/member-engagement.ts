...
export function buildShareAssetDataUrl(input: {
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1080" viewBox="0 0 1080 1080">
      ...
      <circle cx="830" cy="220" r="140" fill="rgba(255,255,255,0.08)" />
      <circle cx="170" cy="905" r="112" fill="rgba(255,255,255,0.08)" />
      <text x="90" y="140" fill="#dffcff" font-size="34" letter-spacing="3" font-family="Poppins, Arial, sans-serif">CENTRALPERK MEMBER MOMENT</text>
      <text x="90" y="295" fill="#ffffff" font-size="72" font-weight="700" font-family="Poppins, Arial, sans-serif">${safeName}</text>
      <text x="90" y="385" fill="#b5f8ff" font-size="42" font-family="Poppins, Arial, sans-serif">${input.achievement}</text>
      <rect x="90" y="455" width="260" height="92" rx="24" fill="#ffffff" />
      <text x="130" y="514" fill="#10213a" font-size="46" font-weight="700" font-family="Poppins, Arial, sans-serif">${input.tier.toUpperCase()}</text>
      <text x="90" y="655" fill="#ffffff" font-size="30" font-family="Poppins, Arial, sans-serif">Referral Code</text>
      <text x="90" y="722" fill="#ffffff" font-size="56" font-weight="700" font-family="Poppins, Arial, sans-serif">${safeCode}</text>
      <text x="90" y="875" fill="#dffcff" font-size="28" font-family="Poppins, Arial, sans-serif">Earn, engage, and unlock more loyalty rewards.</text>
    </svg>
  `;
