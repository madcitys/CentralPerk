...
export declare class AdminMobileService {
    private readonly runtime;
    constructor(runtime: LocalRuntimeService);
    private memberDisplayName;
    private settingsFromState;
    private buildShareEvents;
    private buildReferrals;
    private buildFeedback;
    private buildLeaderboard;
    pointsSnapshot(): Promise<{
        ok: boolean;
        snapshot: {
            members: PointMemberRecord[];
        };
        source: string;
    }>;
    ...
    createNotificationCampaign(input: Record<string, unknown>): Promise<{
        ok: boolean;
        campaign: {
            id: string;
            name: string;
    ...
    createSurvey(input: Record<string, unknown>): Promise<{
        ok: boolean;
        survey: {
            id: string;
            title: string;
    ...
    createWinBackCampaign(input: Record<string, unknown>): Promise<{
        ok: boolean;
        campaign: {
            id: string;
            name: string;
    ...
    updateSettings(input: Record<string, unknown>): Promise<{
        source: string;
        tiers: any[];
        earningRules: any[];
        birthdaySettings: {
