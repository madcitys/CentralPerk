...
import { ensureMemberNotification } from '../app/lib/notifications';
    ...
    try {
      ...
      if (formData.referralCode.trim() && !isLocalDemoProfile) {
        ...
        if (!referral.applied) {
          ...
          await Promise.all([
            ensureMemberNotification({
              memberId: String(memberRecord.member_number),
              channel: 'push',
              subject: 'Referral Reward Received',
              message: `Your referral signup bonus of ${referral.refereePoints} points has been credited.`,
            ...
            referral.referrerMemberId
              ? ensureMemberNotification({
                  ...
                  channel: 'push',
                  subject: 'Referral Reward Received',
                  message: `A friend completed signup using your code. ${referral.referrerPoints} points have been credited.`,
                  isTransactional: true,
                })
